...
cam.Exposure=-10; % sets exposure time (more negative value results in a shorter exposure)
cam.Gain=100; % set the internal amplification of the signal measured for each pixel
...
s = serialport("COM4",9600); % open object for your arduino

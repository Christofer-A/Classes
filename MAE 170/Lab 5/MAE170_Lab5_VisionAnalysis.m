...
%% Grayscale
figure(02)
topleft_x=100; % number of pixels to crop from the left
...
%% Threshold Image
figure(03)
threshold=80; % threshold value to separate grayscale image into binary (from 0 to 255)
...
ctr_min = 4; % center point mimimum pixel radius
ctr_max = 10; % center point maximum pixel radius
rot_sens = 0.98; % algorithm sensitivity to find rotating point

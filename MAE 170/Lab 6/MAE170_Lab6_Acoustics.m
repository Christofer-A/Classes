...
s_speaker = serialport("COM17",115200); % Serialport connection
% create serial object for speaker Arduino
s_move = serialport("COM13",115200);
...
verticalscale1 = 0.5; % channel 1 vertical scale [V]
verticalscale2 = 0.2; % channel 2 vertical scale [V]
